...
public class RequestHandler implements Runnable {
  ...
  private void handleConnectionMessage(Socket clientSocket, byte[] request) throws IOException {
    ...
    System.out.println("MQTT BROKER : Connection Request received.");
    ...
    System.out.println("MQTT BROKER : Client ID : " + this.clientId);
    ...
    System.out.println("MQTT BROKER : Connection ACK sent.");
  }


  private void sendPingResponse(Socket clientSocket) throws IOException {

    System.out.println("MQTT BROKER : Ping request received.");
    ...
    sendResponse(clientSocket, response);
    System.out.println("MQTT BROKER : Ping Response sent.");
  }
  ...
  private void handleSubscribeMessage(Socket clientSocket, byte[] request) throws IOException {
    ...
    System.out.println("MQTT BROKER : Subscribe request received, TOPIC : " + topicName);
  ...
  private void handleUnSubscribeMessage(Socket clientSocket, byte[] request) throws IOException {
    ...
    System.out.println("MQTT BROKER : Unsubscribe request received, TOPIC : " + topicName);
  ...
  private void handlePublishMessage(Socket clientSocket, byte[] request, String byte1Binary)
    ...
    int remainingLength = request[1];
    //System.out.println("MQTT BROKER : Remaining Length : " + remainingLength);
    ...
    System.out.println("MQTT BROKER : Publish request received. , TOPIC : " + topicName);
